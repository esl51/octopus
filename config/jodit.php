...
return [
     ...
     */
    'root' => env('JODIT_FILE_BROWSER_ROOT', 'public/media'),
    ...
    'routes' => [
        ...
        'upload_path' => env('JODIT_FILE_BROWSER_UPLOAD_PATH', 'api/jodit/upload'),
        'browse_path' => env('JODIT_FILE_BROWSER_BROWSE_PATH', 'api/jodit/browse'),
