...
return [
    ...
    'message' => 'Не все данные прошли проверку.',
    'exists' => 'Значение, выбранное для поля :attribute, некорректно.',
    'phone' => 'Поле :attribute содержит некорректный номер.',
    'slug' => 'Поле :attribute может содержать только английские буквы, цифры и дефисы.',
